    ...
    <div className='grid grid-cols-3'>
      <div className='w-full flex items-center'>
        <div className='w-[20px] h-[20px] relative mr-2'>
          <Image src={data?.homeTeam?.crest!} alt={data?.homeTeam?.name!} width={100} height={100} className='object-cover' />
        </div>
      ...
      <div className='w-full flex items-center justify-end'>
        ...
        <div className='w-[20px] h-[20px] relative ml-2'>
          <Image src={data?.awayTeam?.crest!} alt={data.awayTeam?.name!} width={100} height={100} className='object-cover' />
        </div>
      </div>
    </div>
  )
